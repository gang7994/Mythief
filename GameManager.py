...
class GameManager:
    ...
    def show_general_inventory(self):
        ...
        for i, item in enumerate(general_inventory):
            if item[0].name == "general_item0": item[0].image =  pygame.image.load(os.path.join(item_path, "general_item0.png")).convert_alpha()
            elif item[0].name == "general_item1": item[0].image =  pygame.image.load(os.path.join(item_path, "general_item1.png")).convert_alpha()
            elif item[0].name == "general_item2": item[0].image =  pygame.image.load(os.path.join(item_path, "general_item2.png")).convert_alpha()
            elif item[0].name == "general_item3": item[0].image =  pygame.image.load(os.path.join(item_path, "general_item3.png")).convert_alpha()
            elif item[0].name == "general_item4": item[0].image =  pygame.image.load(os.path.join(item_path, "general_item4.png")).convert_alpha()
            elif item[0].name == "general_item5": item[0].image =  pygame.image.load(os.path.join(item_path, "general_item5.png")).convert_alpha()
            elif item[0].name == "general_item6": item[0].image =  pygame.image.load(os.path.join(item_path, "general_item6.png")).convert_alpha()
            elif item[0].name == "general_item7": item[0].image =  pygame.image.load(os.path.join(item_path, "general_item7.png")).convert_alpha()
            elif item[0].name == "general_item8": item[0].image =  pygame.image.load(os.path.join(item_path, "general_item8.png")).convert_alpha()
            elif item[0].name == "general_item9": item[0].image =  pygame.image.load(os.path.join(item_path, "general_item9.png")).convert_alpha()
            elif item[0].name == "general_item10": item[0].image =  pygame.image.load(os.path.join(item_path, "general_item10.png")).convert_alpha()
    ...
    def player_hp(self):
        ...
        if current_hp > 0:
            ...
            elif (self.level.player.is_damage2 or self.level.player.is_damage5 or self.level.player.is_damage10 or self.level.player.is_damage30) and shield !=0:
                shield -= 1
                self.level.player.is_damage2 = False
                self.level.player.is_damage5 = False
                self.level.player.is_damage10 = False
