...
class Player(pygame.sprite.Sprite):
    ...
    def throw_rock(self):
        ...
        if self.is_player_drunken:
            ...
            dir = self.last_dir
        if dir == 2:
            self.images.add(Rock(self.rect.center, 1, self.border_images, effect, self.effect_vol))
        elif dir == 1:
            self.images.add(Rock(self.rect.center, 2, self.border_images, effect, self.effect_vol))
        elif dir == 4:
            self.images.add(Rock(self.rect.center, 3, self.border_images, effect, self.effect_vol))
        elif dir:
            self.images.add(Rock(self.rect.center, 4, self.border_images, effect, self.effect_vol))
